...
def checkoutProject() {
    ...
    checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: "."]], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'e8dd2712-2244-4836-a738-1706443a2146',url: "https://github.com/TacoCTS/WebPOC.git"]]])
